...
if (isset($_POST['addprd'])) {
    ...
    try {
        ...
        $sql = "insert into products(product_name, price,thumbnail, stylist_id, collection_id,description) values('$product','$price', '$image', '$stylist_id', '$collection_id','$description')";
